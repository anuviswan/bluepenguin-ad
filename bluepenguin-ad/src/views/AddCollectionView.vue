...
const handleCreate = async () => {
  if (!collectionId.value.trim()) {
    error.value = 'Collection ID is required';
    return;
  }
  ...
  try {
    await CollectionService.create(collectionId.value.trim(), collectionName.value.trim());
    successMessage.value = `Collection '${collectionName.value.trim()}' has been created successfully! Redirecting...`;
      ...
      <div class="form-container card">
        <div class="form-section">
          ...
          <input 
            ...
            type="text" 
            placeholder="Enter collection ID (e.g., C001)..." 
            class="form-input"
